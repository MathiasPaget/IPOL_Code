...
public:
    ...
    // EDIT
    void Set_Arcs_Cap(arc_id a, tcaptype val){arcs[a].cap = val;};
    tcaptype Get_Arcs_Cap(arc_id a){return arcs[a].cap;};
    node_id Get_Parent(node_id n){return nodes[n].parent->head;};
    // END EDIT
...
protected :
    ...
    // EDIT
    void maxflow_init_tree(int diml);
    // END EDIT
